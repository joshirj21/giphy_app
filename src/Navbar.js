        ...
        return (
            <Navbar bg="light" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav.Link><NavLink className="NavLink" activeClassName="NavLink-active" exact to="/Anime">Anime</NavLink></Nav.Link>
                    <Nav.Link><NavLink className="NavLink" activeClassName="NavLink-active" exact to="/Stickers">Stickers</NavLink></Nav.Link>
                    <Nav.Link><NavLink className="NavLink" activeClassName="NavLink-active" exact to="/Emoji">Emoji</NavLink></Nav.Link>
                    </Nav>
                    <Nav>
